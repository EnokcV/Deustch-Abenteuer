...
export class MainMenuScene {
  ...
  goTo(id, params) {
    console.log('[MainMenu] goTo ->', id, params || {});
    this.game.scenes.switchTo(id, params);
  }
    ...
    try {
      ...
      if (this.game.input.wasPressed('enter')) {
        ...
        try {
          ...
          console.error('[MainMenu] Error ejecutando acción', e);
          this.game.scenes.switchTo('menu');
        }
      }
    } catch (e) {
      console.error('[MainMenu] Error en update():', e);
    }
  }
  ...
  render() {
    try {
      ...
      console.error('[MainMenu] Error en render():', e);
    }
  }
}
